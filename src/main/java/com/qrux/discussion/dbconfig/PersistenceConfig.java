...
@Configuration
@EnableJpaRepositories(basePackages={"com.qrux.discussion"}, 
...
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean  entityManagerFactory() {
        ...
        em.setPackagesToScan("com.qrux.discussion");
        em.setPersistenceUnitName("reports_pu");
    ...
    Properties additionalProperties() {
        ...
        properties.setProperty("spring.jpa.show-sql=true", "true");
        properties.setProperty("jpa.show-sql=true", "true");
        return properties;
    }
}
